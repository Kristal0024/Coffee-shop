      ...
      <div className="w-full">
        ...
        <div className="flex xl:gap-40">
          <div className="flex flex-col gap-4">
            {cart.map((items, index) => {
              return (
                <div
                  key={index}
                  className="border border-[#8D6E6380] w-198 h-56.75 shadow-[6px_6px_8px_rgba(0,0,0,0.4)]"
                >
                  {/* grid head */}
                  ...
                  <div className="showItems grid grid-cols-[2fr_1fr_1fr] items-center p-5">
                    ...
                    <div className="flex gap-4 items-center">
                      <img
                        src={items.img}
                        alt={items.title}
                        className="w-55 h-35 object-cover rounded-sm"
                      />
                      <span>
                        <p>{items.title}</p>
                        <p>Rs {items.price}</p>
          ...
          <div className="flex flex-col border border-button w-100 h-90 shadow-[6px_6px_8px_rgba(0,0,0,0.4)]">
            ...
            <div className="flex justify-center">
              <button className="border w-60 p-3 font-medium bg-button text-background cursor-pointer">
                Checkout
              </button>
            </div>
