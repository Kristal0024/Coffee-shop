  ...
  return (
    <>
      ...
      >
        ...
        <div className="content z-50 relative text-center justify-center flex flex-col h-full items-center gap-5 text-background font-(--font-sans)">
          ...
          <div className="btns flex gap-5">
            <button className="bg-button border-2 border-button w-45 h-15 rounded-4xl cursor-pointer">
              View our Menu
            </button>
            <button className="bg-white/10 border-2 border-button rounded-4xl w-35 h-15 backdrop-blur cursor-pointer">
              Find Us
            </button>
          </div>
        </div>
      ...
      {/* featured */}
      <div className="menuWrapper px-8 py-20 w-full min-h-screen bg-background">
        <div className="heading flex flex-col text-center mb-16 gap-3">
          <h1 className="text-3xl">Featured Favorites</h1>
          <p>
            Hand-picked selections from our seasonal menu, crafted to
            perfection.
          </p>
        </div>
          ...
          <div className="flex w-full items-center justify-center">
            ...
            <div className="w-[50%]">
              ...
              <p className="text-lg mb-8 text-p">
                ...
                designed to be your third place—a warm, inviting environment
                where the aroma of fresh espresso meets the comfort of home.
                Whether you're catching up with friends or finding a quiet
                corner to work, you belong here.
              </p>
              <button className="text-button border-b-2 flex items-center gap-2">
